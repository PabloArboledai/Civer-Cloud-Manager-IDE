...
Resumen: esta carpeta documenta el stack, arquitectura, flujos, seguridad, almacenamiento, autenticacion, tokens, saldos/cuotas y todas las integraciones externas del repo. El objetivo es servir como guia completa para agentes y equipo.
...
- Evita asumir comportamientos; cada seccion se apoya en archivos concretos del repo.
