# antigravity-link-local - Documentación
...
`antigravity-link-local` es un componente integral diseñado para funcionar dentro de nuestra arquitectura distribuida. Todo el sitio está estructurado para operar bajo sus tecnologías nativas (sea Python, PHP, Node.js o contenido estático).

## 2. Dominios y Túneles
Anteriormente, cada sitio tenía su propio nombre de dominio. Para mantener esta estructura:
- **Dominio de Producción:** `antigravity-link-local.civer.cloud`
- **Túnel de Redirección Local:** `localhost:3002`
