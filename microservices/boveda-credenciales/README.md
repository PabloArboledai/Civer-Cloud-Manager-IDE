# boveda-credenciales - Documentación
...
`boveda-credenciales` es un componente integral diseñado para funcionar dentro de nuestra arquitectura distribuida. Todo el sitio está estructurado para operar bajo sus tecnologías nativas (sea Python, PHP, Node.js o contenido estático).

## 2. Dominios y Túneles
Anteriormente, cada sitio tenía su propio nombre de dominio. Para mantener esta estructura:
- **Dominio de Producción:** `boveda-credenciales.civer.cloud`
- **Túnel de Redirección Local:** `localhost:5000`
